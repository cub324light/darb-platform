...
> **🔒 القاعدة العليا:** التسجيل لا يجمع أي معلومة لا يحتاجها النظام لبناء **أول خطة**.
> أي معلومةٍ يحتاجها بعد أسبوع أو شهر تُؤخذ **لاحقاً داخل المنصة**، لا أثناء التسجيل.
>
> **مسؤولية التسجيل حصراً:** مَن أنت · أين أنت الآن · ماذا تريد مستقبلاً (الوجهة العامة) ·
> نتائجك الحالية · هل ستعيد اختباراً · تركيزك الأول. ثم تنتهي المهمة.
...
| اسم الجامعة/التخصص/ترتيب الرغبات/الجامعات المستهدفة | لتخطيط القبول لاحقاً | **يُؤجَّل لخطتي** — الوجهة العامة (جامعة/…) تكفي في التسجيل |

> الوجهة في التسجيل **عامّة فقط** (جامعة/أرامكو/ITC/NITI/ابتعاث/وظيفة/تطوير الإنجليزية).
> تفصيلها (أي جامعة، أي تخصص، ترتيب الرغبات) ينتقل إلى **خطتي** عند بدء تخطيط القبول فعلياً.
> استثناء: الطالب **الجامعي** يحدّد جامعته/تخصصه الحاليَّين لأنهما **هويّته الحالية** (لا وجهة).
