...
export const metadata: Metadata = {
  ...
  description:
    "إجابات موثوقة عن القبول الجامعي في السعودية: النسبة الموزونة والمؤهلة، منصة قبول، طي القيد، السكن الجامعي، اختبار STEP، وشروط الجامعات — مع قوائم مرجعية ونصائح تقديم.",
  alternates: { canonical: "/faq" },
  openGraph: {
    title: "الأسئلة الشائعة — القبول الجامعي ومنصة قبول | درب",
    description: "إجابات موثوقة عن القبول الجامعي في السعودية ومنصة قبول: النسب، طي القيد، السكن، وشروط الجامعات.",
    url: "/faq",
    siteName: "درب",
    locale: "ar_SA",
    type: "website",
  ...
  twitter: {
    ...
    title: "الأسئلة الشائعة — القبول الجامعي ومنصة قبول | درب",
    description: "إجابات موثوقة عن القبول الجامعي في السعودية ومنصة قبول.",
  },
};
    ...
    <div className="min-h-dvh">
      ...
      <main className="px-5 py-6 max-w-2xl mx-auto flex flex-col gap-10 pb-20">
        <p className="text-[14.5px] leading-relaxed -mb-4" style={{ color: "var(--text-muted)" }}>
          كل اللي تحتاج تعرفه عن القبول الجامعي ومنصة قبول — إجابات مختصرة وواضحة، مع قوائم مرجعية ونصائح من تجارب حقيقية.
        </p>
