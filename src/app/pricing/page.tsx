...
/* ▓ مبدأُ التقسيم: **ما يذاكر به الطالبُ مجّانيّ**. لا نبيع أدواتِ المذاكرة —
   تركيزٌ ومساري والتقويم والدفتر والمدرسة وأخطائي ومحفوظاتُه كلُّها في
   ...
   والمحفوظاتُ والتقريرُ الأسبوعيُّ مفتوحةٌ للجميع أصلاً. من أراد صفّاً
...
const COMPARE_FEATURES = [
  ...
  { label: "المحفوظات بالتكرار المتباعد", free: "✓", shaheen: "✓", anqa: "✓" },
