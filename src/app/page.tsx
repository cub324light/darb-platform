...
const FEATURES = [
  ...
  { icon: "🧠", title: "المحفوظات", tag: "تكرار متباعد", desc: "بطاقات سؤال/جواب داخل «أخطائي» تُعيدها عليك قبل أن تنساها بقليل — النظام يحسب موعد كل بطاقة.", color: "#10B981" },
...
const STEPS = [
  ...
  { title: "ذاكر يومياً", desc: "تركيز للجلسات، وأخطائي لأخطائك ومحفوظاتك — كلها في مكان واحد." },
];

const PAIN = [
  { q: "تذاكر بدون خطة؟", a: "مساري يوزّع دروسك على أشهرك من اليوم إلى موعد اختبارك." },
  { q: "تنسى اللي ذاكرته؟", a: "المحفوظات تعيد عليك المعلومة قبل أن تنساها بقليل — لا بعد فوات الأوان." },
...
const SERVICES: {
...
}[] = [
  {
    ...
    full: "خريطة مسار كاملة للفظي والكمي تبدأ من التأسيس وتتدرّج إلى التدريب — كل درس مقفول حتى تتقن اللي قبله. أخطاؤك تنحفظ في «أخطائي» ودويرب يشرح لك سبب كل غلطة، والمحفوظات بالتكرار المتباعد تثبّت القوانين والمعاني قبل ما تنساها. ولوحتك توريك جاهزيتك الفعلية قبل موعد الاختبار.",
  },
  {
    ...
    <div ref={rootRef} className="relative z-[1]">
      ...
      <section id="features" className="px-5 py-16 landing-section-pad max-w-2xl landing-max mx-auto">
        <SectionHead eyebrow="أدواتك"
          ...
          sub="كل أداة تشتغل مع الثانية — جلساتك وأخطاؤك ومحفوظاتك كلها تصبّ في تقدّمك." />
