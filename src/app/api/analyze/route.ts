...
لخّص هذا الجزء في ٣ إلى ٥ نقاط عربية موجزة تُبرز المفاهيم والمهارات الأساسية. بدون مقدمة ولا خاتمة.`;
}
...
### الملخص
ملخص واضح للمحتوى في ٤ إلى ٧ جمل.

### المهارات
- مهارة أو موضوع رئيسي
- (من ٤ إلى ١٢ بنداً، سطر لكل بند، يبدأ بشرطة)

### التصنيف
سطر واحد: نوع المحتوى والمادة والمستوى الدراسي التقريبي.

### الخطة
خطة مذاكرة عملية مقسّمة على أيام (يوم ١، يوم ٢، ...) توزّع المهارات أعلاه بشكل واقعي مع فترات مراجعة.
