...
/* ⚠ DEPRECATED — التجربة الكلاسيكية للوحة الطالب (قالبٌ واحد للجميع: أعمدة/أقسام/
   ترتيب بالسحب). حُفظت كاملةً للتراجع السريع بعد التحوّل إلى الواجهة المرحلية
   (PhaseHome). لا تُركَّب إلا خلف علم تراجع، فلا تعمل آثارها الجانبية. لا تُحذف. */
export default function DashClassic() {
  ...
  return (
    <div className={`page${isWide ? " desk-wide" : ""}`}>
      ...
      <div className="page-content mt-4">
        ...
        {/* ⚠ DEPRECATED — قائمة الأقسام القديمة (قابلة للترتيب/السحب). مُبقاةٌ عمداً
            وغير مُفعّلة للتراجع السريع إن لزم؛ لا تُحذف. المعتمد الآن: البطل + البطاقات. */}
        {false && (<>
