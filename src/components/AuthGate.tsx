...
const PUBLIC_PATHS = [
  ...
  /* «الأسعار» و«آخر التحديثات»: كانتا في sitemap.xml وفي llms.txt، ومع ذلك
     تُقدَّمان للزاحف بأربعين حرفاً فقط — قشرةٌ فارغة. قِسْتُ النصّ الظاهر فظهرتا
     شاذّتين بين خمسين عنواناً. وهما أصلاً ممّا يُقرأ قبل التسجيل لا بعده. */
  "/pricing", "/changelog",
  /* سند منتَجُ وليّ الأمر: يصله رابطُ ابنه وهو لا حسابَ له في درب. لو بقيت خلف
     بوّابة الطالب لَاصطدم بشاشة دخولٍ لا تخصّه. */
  "/sanad", "/sanad/join",
];
