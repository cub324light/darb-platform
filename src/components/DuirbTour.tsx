...
const STEPS = [
  {
    icon: "⏱️",
    title: "تركيز — جلسة مذاكرة",
    body: "كل جلسة 50 دقيقة تركيز + 10 دقائق راحة. ابدأ جلسة من زر «ابدأ جلسة تركيز الآن» في الداشبورد.",
    accent: "#2563EB",
  },
  {
    icon: "🤖",
  ...
  },
  {
    ...
    body: "خريطة مخصصة لمسارك تقسّم المنهج إلى دروس قابلة للتتبع، مع مرحلتَي تأسيس وتدريب.",
    accent: "#F59E0B",
  },
];
