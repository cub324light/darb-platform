...
export const EXAM_PROVIDER: ExamProviderEntry[] = [
  ...
  /* ──────────────── ستيب STEP — قياس ──────────────── */
  {
    trackId: "ستيب",
    hasOfficialDates: true,
    /* ستيب المحوسب متاحٌ طوال السنة في مقرّات قياس، والنوافذ أدناه للورقيّ
       الموسميّ — مثل القدرات تماماً. فلا يُعرَض «مغلق» لطالبٍ يستطيع التسجيل
       اليوم. (والنوافذ الورقية لـ1448 تبقى بلا تواريخ حتى تُعلنها الهيئة.) */
    alwaysOpen: true,
    windows: [
      {
        id: "step-1447-1",
