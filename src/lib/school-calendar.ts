/* ─── التقويم الدراسي السعودي — وزارة التعليم (moe.gov.sa) ───
   1447/1448 (2025/2026): نهاية العام 25/06/2026، بداية العام 23/08/2026
   1448/1449 (2026/2027): بداية 30/08/2026 — منطقة مكة/المدينة/جدة/الطائف */
...
export const SCHOOL_CALENDAR: SchoolEvent[] = [
  /* ── 1447/1448 ── */
  { id: "end-1447",        label: "نهاية العام الدراسي 1447",  from: "2026-06-25", to: "2026-08-22", type: "end"   },
  { id: "start-1448",      label: "بداية العام الدراسي 1448",  from: "2026-08-23", to: "2026-08-23", type: "start" },
  /* ── 1448/1449 ── */
  ...
  { id: "end-1448",        label: "نهاية العام الدراسي 1448",   from: "2027-07-01", to: "2027-08-28", type: "end"   },
  { id: "start-1449",      label: "بداية العام الدراسي 1449",   from: "2027-08-29", to: "2027-08-29", type: "start" },
];
