/* اختبارات دليل أجهزة الجامعة — تشغيل: npx tsx --test src/lib/gear.test.ts */
...
test("المعرفات فريدة والحقول النصية غير فارغة والمدى السعري سليم (0 < min ≤ max)", () => {
...
test("كل فئة جهاز × شريحة ميزانية فيها توصيتان على الأقل", () => {
