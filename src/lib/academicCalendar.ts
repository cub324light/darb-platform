...
export const SAUDI_ACADEMIC_YEARS: AcademicYearData[] = [
  {
    ...
    periods: [
      ...
      /* ── مواعيد قياس (تقديرية — تُحدَّث عند الإعلان الرسمي) ── */
      { kind: "qudurat", label: "القدرات العامة (محوسب)", start: "2026-11-07", end: "2026-11-26", approximate: true },
      { kind: "tahsili", label: "التحصيلي",               start: "2026-12-05", end: "2026-12-12", approximate: true },
      { kind: "step",    label: "STEP (اختبار الإنجليزية)", start: "2026-10-10", end: "2026-10-17", approximate: true },
    ],
  },
];
