...
/* ════════ البيانات (53 توصية: 9 لابتوب، 6 لوحي، 6 طابعة، 9 إكسسوار، 16 برامج، 7 أدوات AI) ════════
...
export const GEAR_ITEMS: GearItem[] = [
  ...
  /* ── AI · عامة للدراسة (كل التخصصات) ── */
  {
    ...
    reason: "كأنه مدرّس خصوصي متاح 24 ساعة يشرح لك اللي ما فهمته — بشرط تستخدمه لتفهم، لا لينجز واجبك مكانك.",
    fitsMajors: ALL,
    priceRangeSAR: { min: 0, max: 0 },
